                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="tabel_beli.php"><i
                                    class="glyphicon glyphicon-edit"></i><span> tabel pembelian</span></a></li>
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Hello</h2>
	...
	<dl>
    <dt>nama:</dt> 
	<dd><?php echo $_SESSION['nama']; ?></dd>
	<br>
    <dt>Member Since:</dt>
    <dd><?php echo $_SESSION['waktu_join']; ?></dd>
	<br>
    <dt>id:</dt>
	...
	<br>
    <dt>alamat:</dt>
    <dd><?php echo $_SESSION['alamat']; ?></dd>
	<br>
	<dt>Email:</dt>
    <dd><?php echo $_SESSION['email']; ?></dd>
	<br>
	<dt>Saldo:</dt>
    <dd><?php echo $_SESSION['saldo']; ?></dd>
	<br>
  ...
  <?php $koneksi = mysql_connect( "localhost", "root", "");
	...
	$query = mysql_query("update data_user set jumlah_transaksi = ((select count(*) from pembelian where id_pembeli='$_SESSION[id]' and status='sudah')+(select count(*) from penjualan where id_penjual='$_SESSION[id]' and status='sudah')) where id='$_SESSION[id]'",$koneksi); ?>
	<dt>Jumlah Transaksi:</dt>
    <dd><?php echo $_SESSION['jumlah_transaksi']; ?></dd>
	<br>
	<dt>Status:</dt>
    <dd><?php echo $_SESSION['enroll']; ?></dd>
  </dl>
</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Here to changed profile</p>
					<form name="form1" method="post" action="insert.php"> 
  <table width="400" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#F0F0F0" bgcolor="#C0C0C0"> 
    ...
    <tr bgcolor="#FFFFFF" align="center"> 
      <td height="40">password lama</td> 
      <td>: 
      <input name="password" type="password" id="password"></td> 
    </tr> 
    <tr bgcolor="#FFFFFF" align="center"> 
      <td height="40">password baru</td> 
      <td>: 
      <input name="passwordbaru" type="password" id="passwordbaru"></td> 
    </tr>
    <tr bgcolor="#FFFFFF" align="center"> 
      <td height="40">Re-type password</td>
	  <td>: 
      <input name="repassword" type="password" id="repassword"></td> 
                ...
                <div class="modal-footer">
                    ...
                    <a href="ubah_profile.php" class="btn btn-primary" >Save changes</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <footer class="row">
        <p class="col-md-9 col-sm-9 col-xs-12 copyright">&copy; <a href="http://usman.it" target="_blank">Mae,bintang, christian
                </a> 2015</p>
