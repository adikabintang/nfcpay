...
<div class="ch-container">
            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="profiles.php"><i class="glyphicon glyphicon-home"></i><span> Profile</span></a>
                        </li>
                        <li><a class="ajax-link" href="tables.php"><i class="glyphicon glyphicon-eye-open"></i><span> tabel penjualan</span></a>
                        </li>
                        <li><a class="ajax-link" href="tabels_beli.php"><i
    ...
    <ul class="breadcrumb">
        <li>
            <a href="homepageAdm.php">Home</a>
        </li>
        <li>
            <a href="profiles.php">Dashboard</a>
        </li>
    </ul>
</div>
<div class=" row">
